        ...
        return (
          ...
          >
            {index === cardsLenght
              ? 1
              : "cards" && (
                  <div className="max-w-sm text-white h-[26rem] rounded overflow-hidden shadow-lg hover:scale-105 lg:hover:scale-110 duration-300 hover:bg-gradient-to-r from-sky-500 to-indigo-600">
